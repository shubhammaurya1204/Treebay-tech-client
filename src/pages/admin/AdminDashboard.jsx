...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#f8f9fa] text-left">
      ...
      {/* ── Sidebar ── */}
      <aside className="w-[240px] shrink-0 bg-white border-r border-[#e2e8f0] flex flex-col sticky top-0 h-screen overflow-hidden max-[768px]:hidden">
        <div className="font-['Cormorant_Garamond',serif] text-[1.35rem] font-bold text-[#1a3a2a] p-[1.8rem_1.6rem_1.2rem] border-b border-[#e2e8f0]">
          Green<span className="text-[#3d8b5a]">Process</span>
        </div>
        ...
        <div className="p-[1rem_1.2rem] border-t border-[rgba(106,170,125,0.1)]">
          <div className="flex items-center gap-[0.75rem] py-[0.7rem] mb-[0.8rem]">
            <div className="w-[34px] h-[34px] rounded-full bg-[#3d8b5a] flex items-center justify-center text-[0.9rem] font-bold text-white shrink-0">A</div>
            <div>
              <div className="text-[0.85rem] font-semibold text-[#1a3a2a] leading-[1.3]">Admin</div>
              <div className="text-[0.72rem] text-[rgba(106,170,125,0.6)]">admin@greenprocess.com</div>
            </div>
          </div>
          <button className="flex items-center gap-[0.6rem] w-full p-[0.6rem_0.9rem] bg-transparent border border-[rgba(106,170,125,0.18)] rounded-[8px] text-[rgba(168,213,181,0.6)] font-sans text-[0.82rem] cursor-pointer transition-all duration-200 hover:bg-[rgba(220,80,80,0.1)] hover:border-[rgba(220,80,80,0.35)] hover:text-[rgba(255,120,120,0.85)]" onClick={handleLogout} title="Logout">
      ...
      {/* ── Main content ── */}
      <main className="flex-1 min-w-0 p-8 overflow-x-auto max-[768px]:p-6">

        {/* Header */}
        <header className="flex items-start justify-between gap-4 mb-7 flex-wrap max-[768px]:flex-col">
          <div>
          ...
          <div className="flex gap-3 items-center flex-wrap">
            ...
            <a href="/" className="py-2 px-4.5 bg-[#3d8b5a] text-white no-underline rounded-[8px] text-[0.82rem] font-semibold transition-colors duration-200 hover:bg-[#2d6645]">← View Site</a>
          </div>
        </header>
