...
const WhyUs = () => {
  const cards = [
    ...
    },
    {
      ...
      desc: "Every technology recommendation is underpinned by rigorous techno-economic modelling. Our feasibility studies and investment cases are designed to withstand lender scrutiny and due diligence."
    }
  ];

  return (
    <section className="py-28 px-[6%] bg-[#f8f9fa] max-[640px]:py-16 max-[640px]:px-6 text-left" id="why-us">
